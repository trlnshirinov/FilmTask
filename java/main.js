...
function newPage() {
    ...
    allCards.slice(start, end).forEach(show => {
        ...
        <div class="col-md-3 mb-4">
            <div class="card h-100 text-dark">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <p class="card-text text-muted mb-1">${show.language}</p>
                    ...
                    <a href="detail.html?id=${show.id}" class="btn btn-primary mt-auto">Detail</a>
                </div>
            </div>
        </div>`;
